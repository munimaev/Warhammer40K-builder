...
WHPsyhoPower.prototype.getSpan = function() {
    var _this = this;
...
var WHPsyhoPowerFabric = function(a) {
    for (var i in a) {
        window[a[i].disciplineName] = function() {
            ...
            return function() {
                ...
                this.icon = icon;
                WHPsyhoPower.apply(this, arguments);
            }
        }()
        window[a[i].disciplineName].prototype = Object.create(WHPsyhoPower.prototype);
