...
var WH_Groupe = function(o) {
    ...
    if (o.structure.hasOwnProperty('necessarily')) {
        for (var i in o.structure.necessarily) {
            this.slots.push( new WH_SlotNecessarily({
                index : i,
                $link : this.$groupPool,
    ...
    if (o.structure.hasOwnProperty('optional')) {
        for (var i in o.structure.optional) {
            this.slots.push( new WH_SlotOptional({
                index : i,
                $link : this.$groupPool,
...
WH_Groupe.prototype.check = function () {
...
WH_Groupe.prototype.unselectAllUnit = function () {
...
//     WH_Groupe.apply(this, arguments);
// }

// // Унаследовать
// DeamonsOfChaos.prototype = Object.create(WH_Groupe.prototype);
